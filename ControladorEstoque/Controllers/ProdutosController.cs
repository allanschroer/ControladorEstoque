...
namespace ControladorEstoque.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Codigo,Name,Descricao,Valor,Quantidade")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Codigo,Name,Descricao,Valor,Quantidade")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
